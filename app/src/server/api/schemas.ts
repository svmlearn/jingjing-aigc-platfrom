...
const merchantMediaManifestClipSchema = z
  .object({
    ...
    cosKey: z.string().trim().min(1).max(1000).optional(),
    storageKey: z.string().trim().min(1).max(1000).optional(),
    thumbCosKey: z.string().trim().min(1).max(1000).nullish(),
    thumbStorageKey: z.string().trim().min(1).max(1000).nullish(),
  ...
  .object({
    ...
    asset: z
      .object({
        ...
        bucketName: z.string().trim().min(1).max(120).optional(),
        sourceCosKey: z.string().trim().min(1).max(1000).optional(),
        sourceStorageKey: z.string().trim().min(1).max(1000).optional(),
