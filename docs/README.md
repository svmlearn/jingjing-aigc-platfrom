...
- `架构规范/2026-05-26-商家视频素材切分与标签数据标准.md`
...
`2026-05-26-商家视频素材切分与标签数据标准.md` 定义商家视频素材从原始上传 asset 到可检索 clip 的 JSON / CSV / SQL 合同，包括逻辑切分、`role:` / `lens:` 标签、provider-neutral storage key、人工与未来自动打标的 ready 门禁。
