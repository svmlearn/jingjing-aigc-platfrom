...
class LocalASRInput(BaseInput):
    ...
    provider: Annotated[str | None, Field(default=None, description="Explicit ASR provider override.")]
    provider_keys: Annotated[Dict[str, Any] | None, Field(default=None, description="Runtime provider secrets/config.")]
    model: Annotated[str | None, Field(default=None, description="Runtime ASR model override.")]
    api_key: Annotated[str | None, Field(default=None, description="Runtime ASR API key.")]
    workspace: Annotated[str | None, Field(default=None, description="Runtime ASR workspace.")]
    format: Annotated[str | None, Field(default=None, description="Runtime ASR input audio format.")]
    sample_rate: Annotated[int | None, Field(default=None, description="Runtime ASR sample rate.")]
    language_hints: Annotated[List[str] | None, Field(default=None, description="Runtime ASR language hints.")]
